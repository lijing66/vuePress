<template><div><h1 id="说说-git-常用的命令有哪些" tabindex="-1"><a class="header-anchor" href="#说说-git-常用的命令有哪些" aria-hidden="true">#</a> 说说 Git 常用的命令有哪些？</h1>
<h2 id="简版" tabindex="-1"><a class="header-anchor" href="#简版" aria-hidden="true">#</a> 简版</h2>
<ul>
<li>git add 提交文件到缓存区</li>
<li>git commit 提交代码到本地仓库</li>
<li>git pull 拉取远程仓库的分支与本地当前分支合并</li>
<li>git fetch 拉取远程仓库的分支</li>
<li>git push 上传本地指定分支到远程仓库</li>
<li>git status 查看当前分支状态</li>
<li>git diff 显示工作区中未添加至暂存区的内容与上一次 commit 的差异</li>
<li>git checkout 新建一个分支或切换分支或撤销工作区文件更改</li>
<li>git merge 合并指定分支到当前分支</li>
</ul>
<h2 id="一、前言" tabindex="-1"><a class="header-anchor" href="#一、前言" aria-hidden="true">#</a> 一、前言</h2>
<p><code v-pre>git</code>的操作可以通过命令的形式如执行，日常使用就如下图 6 个命令即可</p>
<p><img src="https://static.vue-js.com/fe150520-f7af-11eb-991d-334fd31f0201.png" alt=""></p>
<p>实际上，如果想要熟练使用，超过 60 多个命令需要了解，下面则介绍下常见的的<code v-pre>git</code>命令</p>
...
<p><code v-pre>Git</code>自带一个 <code v-pre>git config</code> 的工具来帮助设置控制 <code v-pre>Git</code>外观和行为的配置变量，在我们安装完<code v-pre>git</code>之后，第一件事就是设置你的用户名和邮件地址</p>
...
<p>一个<code v-pre>git</code>项目的初始有两个途径，分别是：</p>
<ul>
<li>git init [project-name]：创建或在当前目录初始化一个 git 代码库</li>
<li>git clone url：下载一个项目和它的整个代码历史</li>
</ul>
<h3 id="日常基本操作" tabindex="-1"><a class="header-anchor" href="#日常基本操作" aria-hidden="true">#</a> 日常基本操作</h3>
...
<h3 id="分支操作" tabindex="-1"><a class="header-anchor" href="#分支操作" aria-hidden="true">#</a> 分支操作</h3>
<ul>
...
<h3 id="远程同步" tabindex="-1"><a class="header-anchor" href="#远程同步" aria-hidden="true">#</a> 远程同步</h3>
<p>远程操作常见的命令：</p>
<ul>
...
<h3 id="撤销" tabindex="-1"><a class="header-anchor" href="#撤销" aria-hidden="true">#</a> 撤销</h3>
<ul>
<li>
...
<blockquote>
<p><code v-pre>reset</code>：真实硬性回滚，目标版本后面的提交记录全部丢失了</p>
<p><code v-pre>revert</code>：同样回滚，这个回滚操作相当于一个提价，目标版本后面的提交记录也全部都有</p>
</blockquote>
<h3 id="存储操作" tabindex="-1"><a class="header-anchor" href="#存储操作" aria-hidden="true">#</a> 存储操作</h3>
...
<p><code v-pre>git</code>常用命令速查表如下所示：</p>
<p><img src="https://static.vue-js.com/0a10f3c0-f7b0-11eb-991d-334fd31f0201.png" alt=""></p>
<h2 id="参考文献" tabindex="-1"><a class="header-anchor" href="#参考文献" aria-hidden="true">#</a> 参考文献</h2>
<ul>
<li>
<p>https://www.ruanyifeng.com/blog/2015/12/git-cheat-sheet.html</p>
</li>
<li>
<p>https://segmentfault.com/a/1190000017875714</p>
</li>
</ul>
</div></template>
