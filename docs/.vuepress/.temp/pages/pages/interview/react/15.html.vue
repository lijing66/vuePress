 ...
 * @LastEditors: lijing
 * @LastEditTime: 2024-01-13 17:29:57
 * @Description: 
-->
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>const EnhancedComponent = highOrderComponent(WrappedComponent);
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>function withLogging(WrappedComponent) {
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>class Home extends React.Component {
    render() {
