 ...
 * @Description: 
-->
<h1 id="说说微信小程序的支付流程" tabindex="-1"><a class="header-anchor" href="#说说微信小程序的支付流程" aria-hidden="true">#</a> 说说微信小程序的支付流程？</h1>
<h2 id="一、前言" tabindex="-1"><a class="header-anchor" href="#一、前言" aria-hidden="true">#</a> 一、前言</h2>
<p>微信小程序为电商类小程序，提供了非常完善、优秀、安全的支付功能</p>
<p>在小程序内可调用微信的<code v-pre>API</code>完成支付功能，方便、快捷</p>
<p>场景如下图所示：</p>
<p><img src="https://static.vue-js.com/6e0cff40-34a0-11ec-a752-75723a64e8f5.png" alt=""></p>
<p><img src="https://static.vue-js.com/34864830-34a0-11ec-8e64-91fdec0f05a1.png" alt=""></p>
<ul>
...
<p>以电商小程序为例</p>
<p>支付流程图如下所示：</p>
<p><img src="https://static.vue-js.com/76b66780-34a0-11ec-8e64-91fdec0f05a1.png" alt=""></p>
<p>具体的做法：</p>
<ul>
<li>打开某小程序，点击直接下单</li>
...
<p>其中后端响应数据必要的信息则是<code v-pre>wx.requestPayment</code>方法所需要的参数，大致如下：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>wx<span class="token punctuation">.</span><span class="token function">requestPayment</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
<p><img src="https://files.mdnice.com/user/155/48efed1f-d67f-45a7-ab2c-89a6424fafa0.png" alt=""></p>
<h2 id="三、结束" tabindex="-1"><a class="header-anchor" href="#三、结束" aria-hidden="true">#</a> 三、结束</h2>
<p>小程序支付和以往的网页、APP微信支付大同小异，可以说小程序的支付变得更加简洁，不需要设置支付目录、域名授权等操作</p>
<h2 id="参考文献" tabindex="-1"><a class="header-anchor" href="#参考文献" aria-hidden="true">#</a> 参考文献</h2>
<ul>
<li>https://pay.weixin.qq.com/wiki/doc/apiv3/open/pay/chapter2_8_0.shtml</li>
<li>https://juejin.cn/post/6844903895970349064</li>
</ul>
</div></template>
