<template><div><h1 id="说说微信小程序的生命周期函数有哪些" tabindex="-1"><a class="header-anchor" href="#说说微信小程序的生命周期函数有哪些" aria-hidden="true">#</a> 说说微信小程序的生命周期函数有哪些？</h1>
<h2 id="一、是什么" tabindex="-1"><a class="header-anchor" href="#一、是什么" aria-hidden="true">#</a> 一、是什么</h2>
<p>跟<code v-pre>vue</code>、<code v-pre>react</code>框架一样，微信小程序框架也存在生命周期，实质也是一堆会在特定时期执行的函数</p>
...
<h3 id="应用的生命周期" tabindex="-1"><a class="header-anchor" href="#应用的生命周期" aria-hidden="true">#</a> 应用的生命周期</h3>
<p>小程序的生命周期函数是在<code v-pre>app.js</code>里面调用的，通过<code v-pre>App(Object)</code>函数用来注册一个小程序，指定其小程序的生命周期回调</p>
<h3 id="页面的生命周期" tabindex="-1"><a class="header-anchor" href="#页面的生命周期" aria-hidden="true">#</a> 页面的生命周期</h3>
<p>页面生命周期函数就是当你每进入/切换到一个新的页面的时候，就会调用的生命周期函数，同样通过<code v-pre>App(Object)</code>函数用来注册一个页面</p>
<h3 id="组件的生命周期" tabindex="-1"><a class="header-anchor" href="#组件的生命周期" aria-hidden="true">#</a> 组件的生命周期</h3>
<p>组件的生命周期，指的是组件自身的一些函数，这些函数在特殊的时间点或遇到一些特殊的框架事件时被自动触发，通过<code v-pre>Component(Object)</code>进行注册组件</p>
<h2 id="二、有哪些" tabindex="-1"><a class="header-anchor" href="#二、有哪些" aria-hidden="true">#</a> 二、有哪些</h2>
<h3 id="应用的生命周期-1" tabindex="-1"><a class="header-anchor" href="#应用的生命周期-1" aria-hidden="true">#</a> 应用的生命周期</h3>
<table>
<thead>
<tr>
<th>生命周期</th>
...
<h3 id="页面的生命周期-1" tabindex="-1"><a class="header-anchor" href="#页面的生命周期-1" aria-hidden="true">#</a> 页面的生命周期</h3>
<table>
<thead>
<tr>
<th>生命周期</th>
...
<h3 id="组件的生命周期-1" tabindex="-1"><a class="header-anchor" href="#组件的生命周期-1" aria-hidden="true">#</a> 组件的生命周期</h3>
<table>
<thead>
<tr>
<th>生命周期</th>
...
<p>还有一些特殊的生命周期，它们并非与组件有很强的关联，但有时组件需要获知，以便组件内部处理，这样的生命周期称为“组件所在页面的生命周期”，在 <code v-pre>pageLifetimes</code> 定义段中定义，如下：</p>
<table>
<thead>
<tr>
<th>生命周期</th>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、执行过程" tabindex="-1"><a class="header-anchor" href="#三、执行过程" aria-hidden="true">#</a> 三、执行过程</h2>
<h3 id="应用的生命周期执行过程" tabindex="-1"><a class="header-anchor" href="#应用的生命周期执行过程" aria-hidden="true">#</a> 应⽤的⽣命周期执行过程：</h3>
<ul>
<li>
...
<h3 id="⻚面生命周期的执行过程" tabindex="-1"><a class="header-anchor" href="#⻚面生命周期的执行过程" aria-hidden="true">#</a> ⻚⾯⽣命周期的执行过程：</h3>
<ul>
...
<li>
<p>再次进入：小程序未销毁 --&gt; (App)onShow(执行上面的顺序），小程序被销毁，（App)onLaunch重新开始执行.</p>
</li>
</ul>
<h2 id="参考文献" tabindex="-1"><a class="header-anchor" href="#参考文献" aria-hidden="true">#</a> 参考文献</h2>
<ul>
<li>https://developers.weixin.qq.com/miniprogram/dev/reference/api/App.html#onLaunch-Object-object</li>
<li>https://developers.weixin.qq.com/miniprogram/dev/reference/api/Page.html#onLoad-Object-query</li>
<li>https://developers.weixin.qq.com/miniprogram/dev/reference/api/App.html#onLaunch-Object-object</li>
</ul>
</div></template>
