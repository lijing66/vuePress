 ...
 * @Description: 
-->
<h1 id="说说提高微信小程序的应用速度的手段有哪些" tabindex="-1"><a class="header-anchor" href="#说说提高微信小程序的应用速度的手段有哪些" aria-hidden="true">#</a> 说说提高微信小程序的应用速度的手段有哪些？</h1>
<p><img src="https://static.vue-js.com/f606d530-3278-11ec-a752-75723a64e8f5.png" alt=""></p>
<h2 id="一、是什么" tabindex="-1"><a class="header-anchor" href="#一、是什么" aria-hidden="true">#</a> 一、是什么</h2>
<p>小程序启动会常常遇到如下图场景：</p>
<p><img src="https://static.vue-js.com/03941230-3279-11ec-8e64-91fdec0f05a1.png" alt=""></p>
...
<p>整体流程如下图：</p>
<p><img src="https://static.vue-js.com/11c0ea90-3279-11ec-a752-75723a64e8f5.png" alt=""></p>
<h2 id="二、手段" tabindex="-1"><a class="header-anchor" href="#二、手段" aria-hidden="true">#</a> 二、手段</h2>
...
<p><img src="https://static.vue-js.com/2034de10-3279-11ec-8e64-91fdec0f05a1.png" alt=""></p>
...
<p>在微信小程序中，提高页面的多次渲染效率主要在于正确使用<code v-pre>setData</code>：</p>
<ul>
<li>不要过于频繁调用setData，应考虑将多次setData合并成一次setData调用</li>
<li>数据通信的性能与数据量正相关，因而如果有一些数据字段不在界面中展示且数据结构比较复杂或包含长字符串，则不应使用<code v-pre>setData</code>来设置这些数据</li>
<li>与界面渲染无关的数据最好不要设置在data中，可以考虑设置在page对象的其他字段下</li>
</ul>
<p>除此之外，对于一些独立的模块我们尽可能抽离出来，这是因为自定义组件的更新并不会影响页面上其他元素的更新</p>
<p>各个组件也将具有各自独立的逻辑空间。每个组件都分别拥有自己的独立的数据、<code v-pre>setData</code>调用</p>
...
<ul>
<li>https://juejin.cn/post/6969779451177484296</li>
<li>https://segmentfault.com/a/1190000008925450</li>
<li>https://juejin.cn/post/6844903638226173965</li>
<li>https://juejin.cn/post/6844903726939897869</li>
</ul>
</div></template>
