 ...
 * @Description: 
-->
<h1 id="数值转二进制求1的个数" tabindex="-1"><a class="header-anchor" href="#数值转二进制求1的个数" aria-hidden="true">#</a> 数值转二进制求1的个数</h1>
<h2 id="需求" tabindex="-1"><a class="header-anchor" href="#需求" aria-hidden="true">#</a> 需求</h2>
<p>编写函数f，它的参数是一个非负的整数，它的返回值是一个它的二进制值中的&quot;1&quot;的个数</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考1" tabindex="-1"><a class="header-anchor" href="#参考1" aria-hidden="true">#</a> 参考1</h2>
<p>toString(2)可以得到一个数的n进制表示。例如： Number(2).toString(2) ===&gt; 10</p>
