 ...
 * @Description: 
-->
<h1 id="instanceof" tabindex="-1"><a class="header-anchor" href="#instanceof" aria-hidden="true">#</a> instanceof</h1>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// instanceof 核心原理是：对象能否通过 __proto__ 找到构造函数的原型</span>
