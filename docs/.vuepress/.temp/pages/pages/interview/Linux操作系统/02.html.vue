 ...
 * @Description: 
-->
<h1 id="说说什么是进程-什么是线程-区别" tabindex="-1"><a class="header-anchor" href="#说说什么是进程-什么是线程-区别" aria-hidden="true">#</a> 说说什么是进程？什么是线程？区别？</h1>
<p><img src="https://static.vue-js.com/f414d8a0-02f6-11ec-a752-75723a64e8f5.png" alt=""></p>
<h2 id="一、进程" tabindex="-1"><a class="header-anchor" href="#一、进程" aria-hidden="true">#</a> 一、进程</h2>
<p>操作系统中最核心的概念就是进程，进程是对正在运行中的程序的一个抽象，是系统进行资源分配和调度的基本单位</p>
<p>操作系统的其他所有内容都是围绕着进程展开的，负责执行这些任务的是<code v-pre>CPU</code></p>
<p><img src="https://static.vue-js.com/3ff146b0-02f6-11ec-8e64-91fdec0f05a1.png" alt=""></p>
...
<h2 id="二、线程" tabindex="-1"><a class="header-anchor" href="#二、线程" aria-hidden="true">#</a> 二、线程</h2>
...
<p><img src="https://static.vue-js.com/63de34c0-02f6-11ec-a752-75723a64e8f5.png" alt=""></p>
<p>但实际上，并不是线程越多，进程的工作效率越高，这是因为在一个进程内，不管你创建了多少线程，它们总是被限定在一颗<code v-pre>CPU</code>内，或者多核<code v-pre>CPU</code>的一个核内</p>
...
<ul>
<li>https://zhuanlan.zhihu.com/p/106283969</li>
<li>https://blog.csdn.net/ThinkWAon/article/details/102021274</li>
<li>https://www.zhihu.com/question/25532384</li>
</ul>
</div></template>
