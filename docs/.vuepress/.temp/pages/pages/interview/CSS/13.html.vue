...
<p>1、从属关系区别</p>
<ul>
<li>@import是 CSS 提供的语法规则，只有导入样式表的作用；</li>
<li>link是HTML提供的标签，不仅可以加载 CSS 文件，还可以定义 RSS、rel 连接属性等。</li>
</ul>
<p>2、加载顺序区别</p>
<ul>
...
<li>link标签作为 HTML 元素，不存在兼容性问题。</li>
</ul>
<p>4、DOM可控性区别</p>
<ul>
<li>可以通过 JS 操作 DOM ，插入link标签来改变样式；</li>
<li>由于 DOM 方法是基于文档的，无法使用@import的方式插入样式。</li>
</ul>
</div></template>
