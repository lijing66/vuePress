<template><div><h1 id="你有写过自定义指令吗-自定义指令的应用场景有哪些" tabindex="-1"><a class="header-anchor" href="#你有写过自定义指令吗-自定义指令的应用场景有哪些" aria-hidden="true">#</a> 你有写过自定义指令吗？自定义指令的应用场景有哪些？</h1>
<h2 id="简版" tabindex="-1"><a class="header-anchor" href="#简版" aria-hidden="true">#</a> 简版</h2>
<ul>
<li>
<p>【作用是什么】：可以对普通 DOM 进行底层操作，例如聚焦输入框。</p>
</li>
<li>
<p>【怎么用】：可以通过 Vue.directive 全局注册一个指令，或者组件内部通过 directives 进行局部注册，它常用的钩子有 inserted，表示被绑定元素插入父节点时调用，还有 update，它表示指令所在组件的 VNode 更新时调用。</p>
</li>
<li>
<p>【场景】：我在实际项目中，用自定义指令处理过图片懒加载，原理就是当图片进入可视区的时候把图片的地址给图片的 src 属性就好啦。</p>
</li>
<li>
<p>【注意】：自定义指令相关的钩子在 Vue3 中发生了变化，主要体现在和组件的生命周期钩子保持了一致，更加容易记忆和理解了。</p>
</li>
</ul>
<h2 id="一、什么是指令" tabindex="-1"><a class="header-anchor" href="#一、什么是指令" aria-hidden="true">#</a> 一、什么是指令</h2>
<p>开始之前我们先学习一下指令系统这个词</p>
<p><strong>指令系统</strong>是计算机硬件的语言系统，也叫机器语言，它是系统程序员看到的计算机的主要属性。因此指令系统表征了计算机的基本功能决定了机器所要求的能力</p>
<p>在<code v-pre>vue</code>中提供了一套为数据驱动视图更为方便的操作，这些操作被称为指令系统</p>
<p>我们看到的<code v-pre>v-</code>开头的行内属性，都是指令，不同的指令可以完成或实现不同的功能</p>
<p>除了核心功能默认内置的指令 (<code v-pre>v-model</code> 和 <code v-pre>v-show</code>)，<code v-pre>Vue</code> 也允许注册自定义指令</p>
<p>指令使用的几种方式：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//会实例化一个指令，但这个指令没有参数</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="二、如何实现" tabindex="-1"><a class="header-anchor" href="#二、如何实现" aria-hidden="true">#</a> 二、如何实现</h3>
<p>注册一个自定义指令有全局注册与局部注册</p>
<p>全局注册主要是通过<code v-pre>Vue.directive</code>方法进行注册</p>
<p><code v-pre>Vue.directive</code>第一个参数是指令的名字（不需要写上<code v-pre>v-</code>前缀），第二个参数可以是对象数据，也可以是一个指令函数</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 注册一个全局自定义指令 `v-focus`</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>局部注册通过在组件<code v-pre>options</code>选项中设置<code v-pre>directive</code>属性</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token literal-property property">directives</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后你可以在模板中任何元素上使用新的 <code v-pre>v-focus</code> property，如下：</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>input</span> <span class="token attr-name">v-focus</span> <span class="token punctuation">/></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>自定义指令也像组件那样存在钩子函数：</p>
<ul>
<li>
<p><code v-pre>bind</code>：只调用一次，指令第一次绑定到元素时调用。在这里可以进行一次性的初始化设置</p>
</li>
<li>
<p><code v-pre>inserted</code>：被绑定元素插入父节点时调用 (仅保证父节点存在，但不一定已被插入文档中)</p>
</li>
<li>
<p><code v-pre>update</code>：所在组件的 <code v-pre>VNode</code> 更新时调用，但是可能发生在其子 <code v-pre>VNode</code> 更新之前。指令的值可能发生了改变，也可能没有。但是你可以通过比较更新前后的值来忽略不必要的模板更新</p>
</li>
<li>
<p><code v-pre>componentUpdated</code>：指令所在组件的 <code v-pre>VNode</code> 及其子 <code v-pre>VNode</code> 全部更新后调用</p>
</li>
<li>
<p><code v-pre>unbind</code>：只调用一次，指令与元素解绑时调用</p>
</li>
</ul>
<p>所有的钩子函数的参数都有以下：</p>
<ul>
<li><code v-pre>el</code>：指令所绑定的元素，可以用来直接操作 <code v-pre>DOM</code></li>
<li><code v-pre>binding</code>：一个对象，包含以下 <code v-pre>property</code>：
<ul>
<li><code v-pre>name</code>：指令名，不包括 <code v-pre>v-</code> 前缀。</li>
<li><code v-pre>value</code>：指令的绑定值，例如：<code v-pre>v-my-directive=&quot;1 + 1&quot;</code> 中，绑定值为 <code v-pre>2</code>。</li>
<li><code v-pre>oldValue</code>：指令绑定的前一个值，仅在 <code v-pre>update</code> 和 <code v-pre>componentUpdated</code> 钩子中可用。无论值是否改变都可用。</li>
<li><code v-pre>expression</code>：字符串形式的指令表达式。例如 <code v-pre>v-my-directive=&quot;1 + 1&quot;</code> 中，表达式为 <code v-pre>&quot;1 + 1&quot;</code>。</li>
<li><code v-pre>arg</code>：传给指令的参数，可选。例如 <code v-pre>v-my-directive:foo</code> 中，参数为 <code v-pre>&quot;foo&quot;</code>。</li>
<li><code v-pre>modifiers</code>：一个包含修饰符的对象。例如：<code v-pre>v-my-directive.foo.bar</code> 中，修饰符对象为 <code v-pre>{ foo: true, bar: true }</code></li>
</ul>
</li>
<li><code v-pre>vnode</code>：<code v-pre>Vue</code> 编译生成的虚拟节点</li>
<li><code v-pre>oldVnode</code>：上一个虚拟节点，仅在 <code v-pre>update</code> 和 <code v-pre>componentUpdated</code> 钩子中可用</li>
</ul>
<blockquote>
<p>除了 <code v-pre>el</code> 之外，其它参数都应该是只读的，切勿进行修改。如果需要在钩子之间共享数据，建议通过元素的 <code v-pre>dataset</code> 来进行</p>
</blockquote>
<p>举个例子：</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">v-demo</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>{ color: 'white', text: 'hello!' }<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
...
<h3 id="输入框防抖" tabindex="-1"><a class="header-anchor" href="#输入框防抖" aria-hidden="true">#</a> 输入框防抖</h3>
<p>防抖这种情况设置一个<code v-pre>v-throttle</code>自定义指令来实现</p>
<p>举个例子：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 1.设置v-throttle自定义指令</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="图片懒加载" tabindex="-1"><a class="header-anchor" href="#图片懒加载" aria-hidden="true">#</a> 图片懒加载</h3>
<p>设置一个<code v-pre>v-lazy</code>自定义指令完成图片懒加载</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> LazyLoad <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="一键-copy-的功能" tabindex="-1"><a class="header-anchor" href="#一键-copy-的功能" aria-hidden="true">#</a> 一键 Copy 的功能</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> Message <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'ant-design-vue'</span>
...
<li>https://juejin.cn/post/6844904197448531975#heading-5</li>
<li>https://www.cnblogs.com/chenwenhao/p/11924161.html#_label2</li>
</ul>
</div></template>
