<template><div><h1 id="说说你对链表的理解-常见的操作有哪些" tabindex="-1"><a class="header-anchor" href="#说说你对链表的理解-常见的操作有哪些" aria-hidden="true">#</a> 说说你对链表的理解？常见的操作有哪些？</h1>
...
<p><img src="https://static.vue-js.com/e4e93490-1c76-11ec-8e64-91fdec0f05a1.png" alt=""></p>
<p>节点用代码表示，则如下：</p>
...
<p>相比于线性表顺序结构，操作复杂。由于不必须按顺序存储，链表在插入的时候可以达到<code v-pre>O(1)</code>的复杂度，比另一种线性表顺序表快得多，但是查找一个节点或者访问特定编号的节点则需要O(n)的时间，而线性表和顺序表相应的时间复杂度分别是<code v-pre>O(logn)</code>和<code v-pre>O(1)</code></p>
...
<p>遍历很好理解，就是根据<code v-pre>next</code>指针遍历下去，直到为<code v-pre>null</code>，如下：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> current <span class="token operator">=</span> head
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="插入" tabindex="-1"><a class="header-anchor" href="#插入" aria-hidden="true">#</a> 插入</h3>
<p>向链表中间插入一个元素，可以如下图所示：</p>
<p><img src="https://static.vue-js.com/f5fe5fd0-1c76-11ec-8e64-91fdec0f05a1.png" alt=""></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果在头节点进行插入操作的时候，会实现<code v-pre>previousNode</code>节点为<code v-pre>undefined</code>，不适合上述方式</p>
...
<p><img src="https://static.vue-js.com/0160cd90-1c77-11ec-a752-75723a64e8f5.png" alt=""></p>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">while</span> <span class="token punctuation">(</span>current <span class="token operator">!=</span> node<span class="token punctuation">)</span><span class="token punctuation">{</span>
  pervious <span class="token operator">=</span> current<span class="token punctuation">;</span>
  current <span class="token operator">=</span> current<span class="token punctuation">.</span>next<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>同样如何希望删除节点处理行为一致，可以在头节点前面添加一个虚拟头节点</p>
<h2 id="三、应用场景" tabindex="-1"><a class="header-anchor" href="#三、应用场景" aria-hidden="true">#</a> 三、应用场景</h2>
<p>缓存是一种提高数据读取性能的技术，在硬件设计、软件开发中都有着非常广泛的应用，比如常见的<code v-pre>CPU</code>缓存、数据库缓存、浏览器缓存等等</p>
<p>当缓存空间被用满时，我们可能会使用<code v-pre>LRU</code>最近最好使用策略去清楚，而实现<code v-pre>LRU</code>算法的数据结构是链表，思路如下：</p>
...
<ul>
<li>https://zh.wikipedia.org/zh-hans/%E9%93%BE%E8%A1%A8</li>
<li>https://mah93.github.io/2019/07/19/js-linked/</li>
</ul>
</div></template>
