<template><div><h1 id="说说你对栈、队列的理解-应用场景" tabindex="-1"><a class="header-anchor" href="#说说你对栈、队列的理解-应用场景" aria-hidden="true">#</a> 说说你对栈、队列的理解？应用场景？</h1>
<p><img src="https://static.vue-js.com/bc57f530-1b99-11ec-a752-75723a64e8f5.png" alt=""></p>
<h2 id="一、栈" tabindex="-1"><a class="header-anchor" href="#一、栈" aria-hidden="true">#</a> 一、栈</h2>
...
<h2 id="二、队列" tabindex="-1"><a class="header-anchor" href="#二、队列" aria-hidden="true">#</a> 二、队列</h2>
...
<p>无论插入或删除，一旦<code v-pre>rear</code>指针增1或<code v-pre>front</code>指针增1 时超出了所分配的队列空间，就让它指向这片连续空间的起始位置，这种队列也就是循环队列</p>
<p>下面实现一个循环队列，如下：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Queue</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上述通过求余的形式代表首尾指针增1 时超出了所分配的队列空间</p>
...
<p>包括编译器的在对输入的语法进行分析的时候，例如<code v-pre>&quot;()&quot;</code>、<code v-pre>&quot;{}&quot;</code>、<code v-pre>&quot;[]&quot;</code>这些成对出现的符号，借助栈的特性，凡是遇到括号的前半部分，即把这个元素入栈，凡是遇到括号的后半部分就比对栈顶元素是否该元素相匹配，如果匹配，则前半部分出栈，否则就是匹配出错</p>
...
<ul>
<li>https://baike.baidu.com/item/%E6%A0%88/12808149</li>
<li>https://baike.baidu.com/item/%E9%98%9F%E5%88%97/14580481</li>
</ul>
</div></template>
