<template><div><h1 id="说说你对冒泡排序的理解-如何实现-应用场景" tabindex="-1"><a class="header-anchor" href="#说说你对冒泡排序的理解-如何实现-应用场景" aria-hidden="true">#</a> 说说你对冒泡排序的理解？如何实现？应用场景？</h1>
...
<p><img src="https://static.vue-js.com/7a363770-2652-11ec-8e64-91fdec0f05a1.png" alt=""></p>
<p>上述可以看到，经过第一趟的排序，可以得到最大的元素，接下来第二趟排序则对剩下的的4个元素进行排序，如下图所示：</p>
<p><img src="https://static.vue-js.com/84b9ddf0-2652-11ec-a752-75723a64e8f5.png" alt=""></p>
...
<p>而在每轮排序中都需要对相邻的两个元素进行比较，在最坏的情况下，每次比较之后都需要交换位置，此时时间复杂度为<code v-pre>O(n^2)</code></p>
<h3 id="优化" tabindex="-1"><a class="header-anchor" href="#优化" aria-hidden="true">#</a> 优化</h3>
<p>对冒泡排序常见的改进方法是加入一标志性变量<code v-pre>exchange</code>，用于标志某一趟排序过程中是否有数据交换</p>
<p>如果进行某一趟排序时并没有进行数据交换，则说明数据已经按要求排列好，可立即结束排序，避免不必要的比较过程</p>
<p>可以设置一标志性变量<code v-pre>pos</code>，用于记录每趟排序中最后一次进行交换的位置，由于<code v-pre>pos</code>位置之后的记录均已交换到位，故在进行下一趟排序时只要扫描到<code v-pre>pos</code>位置即可，如下：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">bubbleSort1</span><span class="token punctuation">(</span><span class="token parameter">arr</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<ul>
<li>https://baike.baidu.com/item/%E5%86%92%E6%B3%A1%E6%8E%92%E5%BA%8F/4602306</li>
<li>https://www.runoob.com/w3cnote/bubble-sort.html</li>
<li>http://data.biancheng.net/view/116.html</li>
<li>https://dsb123dsb.github.io/2017/03/07/js%E5%AE%9E%E7%8E%B0%E5%86%92%E6%B3%A1%E6%8E%92%E5%BA%8F%E4%BB%A5%E5%8F%8A%E4%BC%98%E5%8C%96/</li>
</ul>
</div></template>
