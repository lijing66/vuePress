...
![](http://fanyouf.gitee.io/interview/assets/img/8002c960-815d-11eb-ab90-d9ae814b240d.ad0e58f9.png)
...
尾递归，即在**函数尾位置调用自身**（或是一个尾调用本身的其他函数等等）。尾递归也是递归的一种特殊情形。尾递归是一种特殊的尾调用，即在尾部直接调用自身的递归函数
