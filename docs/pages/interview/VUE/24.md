...
![](http://fanyouf.gitee.io/interview/assets/img/39066120-5ed0-11eb-85f6-6fac77c0c9b3.d70eb0ba.png)
...
![](http://fanyouf.gitee.io/interview/assets/img/c732e150-5c58-11eb-ab90-d9ae814b240d.9c7076e0.png)
...
Vue3 中对不参与更新的元素，会做`静态提升`，只会被创建一次，在渲染时直接复用
...
1.  移除一些不常用的API，例如： $on, $off...
2.  按需导入，方便`Tree shanking`。 任何一个组合式API，如`ref`、`reavtived`、`computed`等，仅仅在用到的时候才打包，没用到的模块都被摇掉，打包的整体体积变小
